...
public class Item {
	...
	public static boolean isFullBody(int itemId) {
		if(itemId == -1)
			return false;
		String[] data = {"Platebody", "Halo's platebody", "Pyromancer garb","platebody", "plate", "top", "wings", "blouse", "monk's robe", "shirt",
				"robetop", "robe top", "tabard", "jacket", "tunic", "chestplate", "leathertop", "brassard", "torso",
				"robe (g)", "robe (t)", "zamorak robe", "hauberk", "coat", "Mummy", "varrock", "decorative", "garb", "zamorak robe", "Justiciar chestguard", "Pernix body" };
    ...
    public static boolean isFullHat(int itemId) {
		...
		if(item.contains("prospector helmet")){
			return false;
		}
		boolean item1 = false;
	...
	public static boolean playerShield(int itemId) {
		String[] data = { "kiteshield", "Chronicle","off-hand",  "Off-Hand","Tome of fire", "Dragonfire ward", "Lit bug lantern", "Unlit bug lantern", "book", "Kiteshield", "shield",
				"Shield", "Kite", "kite", "defender", "ket-xil", "Book", "Off-hand", "Abyssal lantern" };
		String item = getItemName(itemId);
		if (item == null) {
			return false;
		}
	...
	public static boolean playerBody(int itemId) {
		String[] data = { "Halo's platebody","body", "Pyromancer garb","Demon Plate", "Justiciar chestguard", "Torva Platebody", "Black Platebody (W)", "Light Plate", "top", "Owner Plate", "Priest gown", "apron", "shirt",
