...
public class DoubleGates extends GateHandler {
	...
	public static void useDoubleGate(Player player, int objectId) {
		switch (objectId) {
			case 1561:
				handleGate(player, 1561, 1562, 3077, 3259, 3077, 3260, 3077, 3258, 3078, 3258, 2);
			break;
			case 1562:
				handleGate(player, 1562, 1561, 3077, 3260, 3077, 3259, 3078, 3258, 3077, 3258, 2);
			break;
			case 1599:
			...
			if (player.objectX > 3179 && player.objectX < 3182) {
				handleGate(player, 1558, 1560, 3181, 3288, 3181, 3287, 3181, 3289, 3180, 3289, 0);
			} else if (player.objectX > 3161 && player.objectX < 3164) {
				handleGate(player, 1558, 1560, 3163, 3289, 3163, 3288, 3163, 3290, 3162, 3290, 0);
			} else if (player.objectY > 3290 && player.objectY < 3294) {
				handleGate(player, 1558, 1560, 3145, 3292, 3145, 3293, 3145, 3291, 3146, 3291, 2);
			} else if (player.objectY > 3272 && player.objectY < 3275) {
				handleGate(player, 1558, 1560, 3106, 3273, 3105, 3273, 3107, 3273, 3107, 3274, 1);
			} else if (player.objectY > 3265 && player.objectY < 3268) {
				handleGate(player, 1558, 1560, 3252, 3266, 3251, 3266, 3253, 3266, 3253, 3267, 1);
			} else if (player.objectY > 3283 && player.objectY < 3286) {
				handleGate(player, 1558, 1560, 3237, 3285, 3238, 3285, 3236, 3285, 3236, 3284, 5);
			} else if (player.objectY > 3294 && player.objectY < 3297) {
				handleGate(player, 1558, 1560, 3237, 3296, 3238, 3296, 3236, 3296, 3236, 3295, 5);
			} else if (player.objectY > 3300 && player.objectY < 3303) {
				handleGate(player, 1558, 1560, 3240, 3301, 3239, 3301, 3241, 3301, 3241, 3302, 1);
			} else if (player.objectX > 3260 & player.objectX < 3263) {
				handleGate(player, 1558, 1560, 3261, 3322, 3261, 3323, 3261, 3321, 3262, 3321, 2);
			} else if (player.objectY > 3348 && player.objectY < 3351) {
				handleGate(player, 1558, 1560, 2676, 3350, 2677, 3350, 2675, 3350, 2675, 3349, 5);
			} else if (player.objectY > 3313 && player.objectY < 3318) {
				handleGate(player, 1558, 1560, 3174, 3314, 3174, 3315, 3175, 3316, 3174, 3316, 4);
			} else {
				handleGate(player, 1558, 1560, 3198, 3281, 3198, 3280, 3198, 3282, 3197, 3282, 0);
			}
			break;
			case 1560:
			if (player.objectX > 3179 && player.objectX < 3182) {
				handleGate(player, 1560, 1558, 3181, 3287, 3181, 3288, 3180, 3289, 3181, 3289, 0);
			} else if (player.objectX > 3161 && player.objectX < 3164) {
				handleGate(player, 1560, 1558, 3163, 3288, 3163, 3289, 3162, 3290, 3163, 3290, 0);
			} else if (player.objectY > 3290 && player.objectY < 3294) {
				handleGate(player, 1560, 1558, 3145, 3293, 3145, 3292, 3146, 3291, 3145, 3291, 2);
			} else if (player.objectY > 3272 && player.objectY < 3275) {
				handleGate(player, 1560, 1558, 3105, 3273, 3106, 3273, 3107, 3274, 3107, 3273, 1);
			} else if (player.objectY > 3265 && player.objectY < 3268) {
				handleGate(player, 1560, 1558, 3251, 3266, 3252, 3266, 3253, 3267, 3253, 3266, 1);
			} else if (player.objectY > 3283 && player.objectY < 3286) {
				handleGate(player, 1560, 1558, 3238, 3285, 3237, 3285, 3236, 3284, 3236, 3285, 5);
			} else if (player.objectY > 3294 && player.objectY < 3297) {
				handleGate(player, 1560, 1558, 3238, 3296, 3237, 3296, 3236, 3295, 3236, 3296, 5);
			} else if (player.objectY > 3300 && player.objectY < 3303) {
				handleGate(player, 1560, 1558, 3239, 3301, 3240, 3301, 3241, 3302, 3241, 3301, 1);
			} else if (player.objectX > 3260 & player.objectX < 3263) {
				handleGate(player, 1560, 1558, 3261, 3323, 3261, 3322, 3262, 3321, 3261, 3321, 2);
			} else if (player.objectY > 3348 && player.objectY < 3351) {
				handleGate(player, 1560, 1558, 2677, 3350, 2676, 3350, 2675, 3349, 2675, 3350, 5);
			} else if (player.objectY > 3313 && player.objectY < 3318) {
				handleGate(player, 1560, 1558, 3174, 3315, 3174, 3314, 3174, 3316, 3175, 3316, 4);
			} else {
				handleGate(player, 1560, 1558, 3198, 3280, 3198, 3281, 3197, 3282, 3198, 3282, 0);
			}
			break;
			case 12986:
			...
			if (player.objectY > 9830 && player.objectY < 9833 && player.absY != 9830) {
				handleSpecialGate(player, 1569, 1568, 2897, 9831, 2897, 9832, 2898, 9831, 2898, 9832, 3);
			} else if (player.objectY > 3866 && player.objectY < 3869) {
				handleSpecialGate(player, 1569, 1568, 3075, 3868, 3076, 3868, 3075, 3867, 3076, 3867, 4);
			/*Heroes Guild*/
			} else if (player.objectX > 2908 && player.objectX < 2911) {
				//newx, newy, newx2, newy2, oldx, oldy, oldx2, oldy2
				handleSpecialGate(player, 1569, 1568, 2910, 9909, 2909, 9909, 2910, 9910, 2909, 9910, 0);
			} else if (player.objectY > 9908 && player.objectY < 9911) {
				handleSpecialGate(player, 1569, 1568, 3104, 9910, 3104, 9909, 3103, 9910, 3103, 9909, 7);
			} else if (player.objectX > 3110 && player.objectX < 3113 && player.absY != 3513 && player.absY != 3516) {
				handleSpecialGate(player, 1569, 1568, 3111, 3514, 3111, 3515, 3112, 3514, 3112, 3515, 3);
			} else if (player.objectX > 3104 && player.objectX < 3107 && player.absX != 3104 && player.absX != 3107) {
				handleSpecialGate(player, 1569, 1568, 3105, 9945, 3106, 9945, 3105, 9944, 3106, 9944, 6);
			} else if (player.objectX > 3144 && player.objectX < 3147) {
				handleSpecialGate(player, 1569, 1568, 3146, 9871, 3146, 9870, 3145, 9871, 3145, 9870, 1);
			}
			break;
			case 1568:
			if (player.objectY > 9830 && player.objectY < 9833 && player.absY != 9830) {
				handleSpecialGate(player, 1568, 1569, 2897, 9832, 2897, 9831, 2898, 9832, 2898, 9831, 1);
			} else if (player.objectY > 3866 && player.objectY < 3869) {
				handleSpecialGate(player, 1568, 1569, 3076, 3868, 3075, 3868, 3076, 3867, 3075, 3867, 4);
			/* Heroes Guild*/
			} else if (player.objectX > 2908 && player.objectX < 2911) {
				//newx, newy, newx2, newy2, oldx, oldy, oldx2, oldy2
				handleSpecialGate(player, 1568, 1569, 2909, 9909, 2910, 9909, 2909, 9910, 2910, 9910, 2);
			} else if (player.objectY > 9908 && player.objectY < 9911) {
				handleSpecialGate(player, 1568, 1569, 3104, 9909, 3104, 9910, 3103, 9909, 3103, 9910, 5);
			} else if (player.objectX > 3110 && player.objectX < 3113 && player.absY != 3513 && player.absY != 3516) {
				handleSpecialGate(player, 1568, 1569, 3111, 3515, 3111, 3514, 3112, 3515, 3112, 3514, 3);
			} else if (player.objectX > 3104 && player.objectX < 3107 && player.absX != 3104 && player.absX != 3107) {
				handleSpecialGate(player, 1568, 1569, 3106, 9945, 3105, 9945, 3106, 9944, 3105, 9944, 4);
			} else if (player.objectX > 3144 && player.objectX < 3147) {
				handleSpecialGate(player, 1568, 1569, 3146, 9870, 3146, 9871, 3145, 9870, 3145, 9871, 5);
			}
			break;
			case 3506:
