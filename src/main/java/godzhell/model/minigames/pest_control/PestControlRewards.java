package godzhell.model.minigames.pest_control;
...
public class PestControlRewards {
	...
	static class ExperienceReward extends Reward {
		...
		public void purchase(Player player) {
			...
			player.getPA().addSkillXP((player.getMode().isOsrs() ? experience / 104 : experience) * cost, skillId, true);
			player.sendMessage("You have received " + ((player.getMode().isOsrs() ? experience / 104 : experience) * cost) + " experience in exchange for " + cost + " points.");
		}
	}
