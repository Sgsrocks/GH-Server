...
import godzhell.model.content.IronManInterface.Action;
...
import godzhell.model.holiday.christmas.ChristmasToy;
import godzhell.model.holiday.christmas.ChristmasToyUpgrade;
...
import godzhell.model.minigames.bounty_hunter.BountyHunterEmblem;
...
import godzhell.server.data.SerializablePair;
...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 287:
			...
			break;
		case 288:
			sendNpcChat1("Hurry Then!", c.talkingNpc, "Doric");
			c.nextChat = 0;
			break;
		case 289:
			sendNpcChat1(
		...
		case 291:
			...
			break;
		case 292:
			sendNpcChat1("So you want to use my anivils?", c.talkingNpc,
					"Doric");
			c.nextChat = 298;
			break;
		case 298:
		...
		case 297:
			sendNpcChat4(
					...
					c.talkingNpc, "Doric");
			c.getItems().addOrDropItem(1265, 1);
			c.nextChat = 99;
			break;
		case 299:
			...
			break;
		case 300:
			sendNpcChat1("Thanks for the help!", c.talkingNpc, "Doric");
			c.nextChat = 0;
			break;
		}
