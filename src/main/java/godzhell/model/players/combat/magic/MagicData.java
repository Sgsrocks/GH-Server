...
public class MagicData {
	...
	public static int getMagicGraphic(Player c, int i) {
		...
		return MAGIC_SPELLS[c.oldSpellId][5];
	}
	 ...
	 * rune - amount - rune - amount - rune - amount
	 */
	public final static int[][] MAGIC_SPELLS = {// Modern Spells
			...
			{ -1, 33, 728, 142, 143, 144, 0, 35, 556, 1, 563, 1, 0, 0, 0, 0 }, // telegrab - 51

			//Other
			{ -1, 75, 1167, 1251, 1252, 1253, 29, 35, 0, 0, 0, 0, 0, 0, 0, 0 }, // trident of the seas -52
			{ -1, 75, 1167, 665, 1040, 1042, 32, 35, 0, 0, 0, 0, 0, 0, 0, 0 }, // trident of the swamp -53

			{ 1173, 43, 725, 148, 0, 0, 0, 0, 554, 4, 561, 1, 0, 0, 0, 0 }, // superheat item - 54

			{ 55, 94, 0, 0, 0, 0, 0, 10000, 9075, 4, 557, 10, 560, 2, 0, 0 }, // Vengeance 55

			{ 1155, 7, 0, 0, 0, 0, 0, 0, 555, 1, 564, 1, 0, 0, 0, 0 }, // Lvl-1 Enchant - Sapphire - 56
			{ 1165, 27, 0, 0, 0, 0, 0, 0, 556, 3, 564, 1, 0, 0, 0, 0 }, // Lvl-2 Enchant - Emerals - 57
			{ 1176, 49, 0, 0, 0, 0, 0, 0, 554, 5, 564, 1, 0, 0, 0, 0 }, // Lvl-3 Enchant - Ruby - 58
			{ 1180, 57, 0, 0, 0, 0, 0, 0, 557, 10, 564, 1, 0, 0, 0, 0 }, // Lvl-4 Enchant - Diamond - 59
			{ 1187, 68, 0, 0, 0, 0, 0, 0, 555, 15, 564, 1, 557, 15, 0, 0 }, // Lvl-5 Enchant - Dragonstone - 60
			{ 6003, 87, 0, 0, 0, 0, 0, 0, 554, 20, 564, 1, 557, 20, 0, 0 }, // Lvl-6 Enchant - Onyx - 61
			{ 23649, 91, 0, 0, 0, 0, 0, 0, 566, 20, 564, 1, 565, 20, 0, 0 }, // Lvl-7 Enchant - Zenyte - 62
			//{ -1, 75, 1167, 1582, 1580, 1581, 37, 40, 0, 0, 0, 0, 0, 0, 0, 0 }, // DawnBringer - 63
			{-1, 1, 1167, 1546, 1547, 1548, 35, 10, 0, 0, 0, 0, 0, 0, 0, 0},//Dawnbringer 63

			//City teleports
			{ -1, 25, 0, 0, 0, 0, 0, 0, 554, 1, 556, 3, 563, 1, 0, 0 }, //Varrock - 64
			{ -1, 31, 0, 0, 0, 0, 0, 0, 557, 1, 556, 3, 563, 1, 0, 0 }, //Lumbridge - 65
			{ -1, 37, 0, 0, 0, 0, 0, 0, 555, 1, 556, 3, 563, 1, 0, 0 }, //Falador - 66
			{ -1, 45, 0, 0, 0, 0, 0, 0, 556, 5, 563, 1, 0, 0, 0, 0 }, //Camelot - 67
			{ -1, 51, 0, 0, 0, 0, 0, 0, 555, 2, 563, 2, 0, 0, 0, 0 }, //Ardougne - 68
			{ -1, 58, 0, 0, 0, 0, 0, 0, 557, 2, 563, 2, 0, 0, 0, 0 }, //Watchtower - 69
			{ -1, 61, 0, 0, 0, 0, 0, 0, 554, 2, 563, 2, 0, 0, 0, 0 }, //Trollheim - 70

			{ -1, 54, 0, 0, 0, 0, 0, 0, 563, 2, 554, 1, 556, 1, 0, 0 }, //Paddewwa - 71
			{ -1, 60, 0, 0, 0, 0, 0, 0, 563, 2, 566, 1, 0, 0, 0, 0 }, //Senntisten - 72
			{ -1, 66, 0, 0, 0, 0, 0, 0, 563, 2, 565, 1, 0, 0, 0, 0 }, //Kharyrll - 73
			{ -1, 72, 0, 0, 0, 0, 0, 0, 563, 2, 555, 4, 0, 0, 0, 0 }, //Lassar - 74
			{ -1, 78, 0, 0, 0, 0, 0, 0, 563, 2, 554, 3, 556, 2, 0, 0 }, //Dareeyak - 75
			{ -1, 84, 0, 0, 0, 0, 0, 0, 563, 2, 566, 2, 0, 0, 0, 0 }, //Carrallangar - 76
			{ -1, 90, 0, 0, 0, 0, 0, 0, 563, 2, 565, 2, 0, 0, 0, 0 }, //Annakarl - 77
			{ -1, 96, 0, 0, 0, 0, 0, 0, 563, 2, 555, 8, 0, 0, 0, 0 }, //Ghorrok - 78

			{ -1, 69, 0, 0, 0, 0, 0, 0, 9075, 2, 563, 1, 557, 2, 0, 0 }, //Moonclan - 79
			{ -1, 71, 0, 0, 0, 0, 0, 0, 9075, 2, 563, 1, 557, 6, 0, 0 }, //Ourania - 80
			{ -1, 72, 0, 0, 0, 0, 0, 0, 9075, 2, 563, 1, 555, 1, 0, 0 }, //Waterbirth - 81
			{ -1, 75, 0, 0, 0, 0, 0, 0, 9075, 2, 563, 2, 554, 3, 0, 0 }, //Barbarian - 82
			{ -1, 78, 0, 0, 0, 0, 0, 0, 9075, 2, 563, 2, 555, 4, 0, 0 }, //Khazard - 83
			{ -1, 85, 0, 0, 0, 0, 0, 0, 9075, 3, 563, 3, 555, 10, 0, 0 }, //Fishing guild - 84
			{ -1, 87, 0, 0, 0, 0, 0, 0, 9075, 3, 563, 3, 555, 10, 0, 0 }, //Catherby - 85
			{ -1, 89, 0, 0, 0, 0, 0, 0, 9075, 3, 563, 3, 555, 8, 0, 0 }, //Ice plateu - 86

			//Lunar spells
			{ 30048, 68, 0, 0, 0, 0, 0, 0, 9075, 1, 563, 1, 557, 10, 0, 0 }, //Cure Other - 87
			{ 30130, 75, 0, 0, 0, 0, 0, 0, 9075, 2, 564, 2, 559, 5, 0, 0 }, //Stat spy - 88
			{ 30282, 91, 0, 0, 0, 0, 0, 0, 9075, 3, 563, 2, 561, 1, 0, 0 }, //Energy Transfer - 89
			{ 30290, 92, 0, 0, 0, 0, 0, 0, 9075, 3, 563, 3, 565, 1, 0, 0 }, //Heal Other - 90
			{ 30298, 93, 0, 0, 0, 0, 0, 0, 9075, 3, 560, 2, 557, 10, 0, 0 }, //Vengeance other - 91

			//Orb charging
			{ -1, 56, 0, 0, 0, 0, 0, 0, 555, 30, 564, 3, 0, 0, 0, 0 }, //Water 92
			{ -1, 60, 0, 0, 0, 0, 0, 0, 557, 30, 564, 3, 0, 0, 0, 0 }, //Earth 93
			{ -1, 63, 0, 0, 0, 0, 0, 0, 554, 30, 564, 3, 0, 0, 0, 0 }, //Fire 94
			{ -1, 66, 0, 0, 0, 0, 0, 0, 556, 30, 564, 3, 0, 0, 0, 0 }, //Air 95

			{ 22644 + 975, 81, 7855, 1455, 1456, 1457, 30, 130, 556, 7, 21880, 1, 0, 0, 0, 0 }, // wind surge - 96
			{ 22658 + 975, 85, 7855, 1458, 1459, 1460, 33, 130, 556, 7, 21880, 1, 555, 10, 0, 0 }, // water surge - 97
			{ 22628 + 975, 90, 7855, 1461, 1462, 1463, 35, 130, 556, 7, 21880, 1, 557, 10, 0, 0 }, // earth surge -98
			{ 22608 + 975, 95, 7855, 1464, 1465, 1466, 38, 130, 556, 7, 21880, 1, 554, 10, 0, 0 }, // fire surge - 99
			{-1, 75, 1167, 1540, 1539, 1541, 34, 40, 0, 0, 0, 0, 0, 0, 0, 0},//Sanguinesti staff main spell 100
			{-1, 75, 1167, 1540, 1539, 1542, 34, 40, 0, 0, 0, 0, 0, 0, 0, 0},//Sanguinesti staff passive ability 101
