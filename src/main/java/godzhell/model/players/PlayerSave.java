...
import godzhell.model.content.LootingBag.LootingBagItem;
import godzhell.model.content.achievement_diary.DifficultyAchievementDiary.EntryDifficulty;
...
import godzhell.model.content.presets.PresetContainer;
import godzhell.model.content.titles.Title;
...
public class PlayerSave {
		...
		while (EndOfFile == false && line != null) {
			...
			if (spot > -1) {
				...
				case 2:
					...
					} else if (token.equals("motherLode-ore")) {
						p.MotherLoad_Ore_amount = Integer.parseInt(token2);
					...
					case "cookAss":
						...
						break;
					case "bananas":
						p.bananas = Integer.parseInt(token2);
						break;
					case "sheepShear":
					...
					case "knightS":
						...
						break;
					case "ptjob":
						p.ptjob = Integer.parseInt(token2);
						break;
					case "questPoints":
					...
					case "demonSlayer":
						...
						break;
					case "ChronicleCharges":
						p.ChronicleCharges = Integer.parseInt(token2);
						break;
					case "hasBankpin":
						p.hasBankpin = Boolean.parseBoolean(token2);
						break;
				...
				case 19:
					for (int j = 0; j < token3.length; j++) {
						p.getMusic().getUnlockedMusic().add(Integer.parseInt(token3[j]));
					}
					break;
				}
			} else {
				if (line.equals("[ACCOUNT]")) {
					...
					ReadMode = 18;
				} else if (line.equals("[MUSIC-TRACKS]")) {
					ReadMode = 19;
	...
	public static boolean saveGame(Player p) {
		...
		try {
			...
			characterfile.newLine();
			characterfile.write("bankPin1 = " + p.bankPin1);
			characterfile.newLine();
			characterfile.write("bankPin2 = " + p.bankPin2);
			characterfile.newLine();
			characterfile.write("bankPin3 = " + p.bankPin3);
			characterfile.newLine();
			characterfile.write("bankPin4 = " + p.bankPin4);
			characterfile.newLine();
			characterfile.write("hasBankpin = " + p.hasBankpin);
			characterfile.newLine();
			characterfile.write("pinRegisteredDeleteDay = " + p.pinDeleteDateRequested);
			characterfile.newLine();
			characterfile.write("requestPinDelete = " + p.requestPinDelete);
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("motherLode-ore = " + p.MotherLoad_Ore_amount);
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("ptjob = " + p.ptjob);
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("witchspot = " + p.witchspot);
			characterfile.newLine();
			characterfile.write("restGhost = " + p.restGhost);
			characterfile.newLine();
			characterfile.write("vampSlayer = " + p.vampSlayer);
			characterfile.newLine();
			characterfile.write("questPoints = " + p.QuestPoints);
			characterfile.newLine();
			characterfile.write("dragonSlayer = " + p.dragonSlayer);
			characterfile.newLine();
			characterfile.write("demonSlayer = " + p.demonSlayer);
			characterfile.newLine();
			characterfile.write("ChronicleCharges = " + p.ChronicleCharges);
			characterfile.newLine();
			characterfile.newLine();
			...
			characterfile.newLine();
			characterfile.write("[MUSIC-TRACKS]");
			characterfile.newLine();
			for (int i = 0; i < p.getMusic().getUnlockedMusic().size(); i++) {
				characterfile.write("unlockedMusic = " + p.getMusic().getUnlockedMusic().get(i));
				characterfile.newLine();			
}
			characterfile.newLine();
