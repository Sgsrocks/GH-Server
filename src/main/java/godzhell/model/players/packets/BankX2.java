...
import godzhell.model.content.LootValue;
...
import godzhell.model.content.skills.TabletCreation;
	...
	public void processPacket(Player c, int packetType, int packetSize) {
		...
		case 5064:
			...
			if (!c.getItems().playerHasItem(c.xRemoveId, Xamount))
				return;
			if (c.inPartyRoom) {
				PartyRoom.depositItem(c, c.xRemoveId, c.getItems().itemAmount(c.playerItems[c.xRemoveSlot]));
				break;
			}
