package godzhell.model.content.n_tp;
...
public enum TeleportLocations {
    ...
    HOME(new Position(Config.START_LOCATION_X, Config.START_LOCATION_Y, 0), "Teleporting you home."),
    ...
    //MONSTERS
    ROCK_CRABS(new Position(2679, 3717, 0), "done"),
    EXPERIMENTS(new Position(3558, 9948, 0), "d"),
    YAKS(new Position(3204, 3264, 0), "d"),
    BANDITS(new Position(3171, 2981, 0), "d"),
    ...
    MAGEBANK(new Position(3090, 3956, 0), ""),
    ...
    CHILL(new Position(2856, 3812, 1), ""),
