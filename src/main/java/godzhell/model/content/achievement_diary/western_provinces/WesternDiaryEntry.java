package godzhell.model.content.achievement_diary.western_provinces;
...
public enum WesternDiaryEntry {
	//Easy
	PEST_CONTROL("Save the island of pest control: %totalstage", 5),
	...
	//Medium
	CRYSTAL("Recharge a Crystal Bow by talking to the Weird Old Man"),
	FIGHTER_TORSO("Purchase a fighter torso at Pest Control"),
	FIGHTER_HAT("Purchase a fighter hat at Pest Control"),
	...
	PICKPOCKET_GNOME("Pickpocket a gnome: %totalstage", 100),
