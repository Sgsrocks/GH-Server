...
import static godzhell.model.content.achievement_diary.western_provinces.WesternDiaryEntry.*;
...
public final class WesternAchievementDiary extends StatefulAchievementDiary<WesternDiaryEntry>{
	...
	public static final Set<WesternDiaryEntry> MEDIUM_TASKS = EnumSet.of(CRYSTAL, FIGHTER_TORSO, FIGHTER_HAT);
