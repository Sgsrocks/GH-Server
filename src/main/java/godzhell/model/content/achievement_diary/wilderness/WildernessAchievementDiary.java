package godzhell.model.content.achievement_diary.wilderness;

import static godzhell.model.content.achievement_diary.wilderness.WildernessDiaryEntry.*;
...
public final class WildernessAchievementDiary extends StatefulAchievementDiary<WildernessDiaryEntry>{
	...
	public static final Set<WildernessDiaryEntry> EASY_TASKS = EnumSet.of(LOW_ALCH, WILDERNESS_LEVER, WILDERNESS_ALTAR, KILL_EARTH_WARRIOR, DEMONIC_RUINS, KBD_LAIR, MINE_IRON_WILD);
	...
	public static final Set<WildernessDiaryEntry> HARD_TASKS = EnumSet.of(CLAWS_OF_GUTHIX, SMITH_ADAMANT_SCIMITAR, CHAOS_ELEMENTAL, CRAZY_ARCHAEOLOGIST, CHAOS_FANATIC, SCORPIA, SPIRITUAL_WARRIOR);
