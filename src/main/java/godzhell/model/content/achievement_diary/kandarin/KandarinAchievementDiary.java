package godzhell.model.content.achievement_diary.kandarin;

import static godzhell.model.content.achievement_diary.kandarin.KandarinDiaryEntry.*;
...
public final class KandarinAchievementDiary extends StatefulAchievementDiary<KandarinDiaryEntry>{
	...
	public static final Set<KandarinDiaryEntry> ELITE_TASKS = EnumSet.of(WEAPON_POISON_PLUS_PLUS, CATHERBY_TELEPORT);
