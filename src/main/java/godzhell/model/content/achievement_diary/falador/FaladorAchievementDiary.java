package godzhell.model.content.achievement_diary.falador;

import static godzhell.model.content.achievement_diary.falador.FaladorDiaryEntry.*;

import java.util.EnumSet;
import java.util.Set;

import godzhell.model.content.achievement_diary.StatefulAchievementDiary;
import godzhell.model.players.Player;

public final class FaladorAchievementDiary extends StatefulAchievementDiary<FaladorDiaryEntry>{
	
	public static final Set<FaladorDiaryEntry> EASY_TASKS = EnumSet.of(CHOP_WILLOW, PICK_FLAX, PICKPOCKET_MAN, COMPOST_BUCKET, GRAPPLE_NORTH_WALL, TELEPORT_TO_FALADOR);
	...
	public static final Set<FaladorDiaryEntry> HARD_TASKS = EnumSet.of(PICK_POSION_BERRY, KILL_GIANT_MOLE, MINE_MITHRIL);
	
	public static final Set<FaladorDiaryEntry> ELITE_TASKS = EnumSet.of(HARVEST_TORSTOL, MINE_GEM_FAL);
