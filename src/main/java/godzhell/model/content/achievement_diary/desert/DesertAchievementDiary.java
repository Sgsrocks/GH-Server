package godzhell.model.content.achievement_diary.desert;

import static godzhell.model.content.achievement_diary.desert.DesertDiaryEntry.*;
...
public final class DesertAchievementDiary extends StatefulAchievementDiary<DesertDiaryEntry>{
	...
	public static final Set<DesertDiaryEntry> MEDIUM_TASKS = EnumSet.of(KILL_BANDIT,PASS_GATE_ROBES,COMBAT_POTION,CHOP_TEAK,PICKPOCKET_THUG,ACTIVATE_ANCIENT,KILL_VULTURE,DARKLIGHT);
	
	public static final Set<DesertDiaryEntry> HARD_TASKS = EnumSet.of(TRAVEL, KILL_DUST_DEVIL);
