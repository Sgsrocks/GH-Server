...
public enum RewardLevel {
	...
	EASY(TreasureTrails.EASY_CLUE_SCROLL, ItemID.REWARD_CASKET_EASY),
	MEDIUM(TreasureTrails.MEDIUM_CLUE_SCROLL, ItemID.REWARD_CASKET_MEDIUM),
	HARD(TreasureTrails.HARD_CLUE_SCROLL, ItemID.REWARD_CASKET_HARD),
	MASTER(TreasureTrails.MASTER_CLUE_SCROLL, ItemID.REWARD_CASKET_MASTER);
