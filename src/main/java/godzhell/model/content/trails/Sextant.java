...
public class Sextant {
    ...
    public static void initializeRandomSextantInterface(Player c) {
        ...
        c.getPA().showInterface(SEXTANT_INTERFACE);
        updateSextant(c);
    }
    ...
    public static void moveSextantBarWithFormula(Player c, double degreeGiven) {
        ...
        c.getPA().sendFrame230(SEXTANT_BAR, SEXTANT_ROTATION1, realDegree, SEXTANT_BAR_ZOOM);

        c.getPA().sendFrame70(degree > 0 ? -(x - c.rotationFactor / 2) : (x + c.rotationFactor / 2), -y, SEXTANT_BAR);
    ...
    private static void moveSextantGlobalPieceWithFormula(Player c) {
        ...
        c.getPA().sendFrame230(SEXTANT_TELESCOPE, SEXTANT_ROTATION1, realDegree, SEXTANT_GLOBAL_ZOOM);
        c.getPA().sendFrame230(SEXTANT_ARC, SEXTANT_ROTATION1, realDegree, SEXTANT_GLOBAL_ZOOM);
    ...
    public static void moveLandScapeWithFormula(Player c) {
        c.getPA().sendFrame70(0, c.sextantLandScapeCoords, SEXTANT_LANDSCAPE);
    }
    ...
    public static void moveSunWithFormula(Player c) {
        c.getPA().sendFrame70(0, c.sextantSunCoords, SEXTANT_SUN);
    }
    ...
    public static void displayPosition(Player c) {
        ...
        c.getDH().sendStatement(resultX, resultY);
        c.sendMessage("the sextant displays:");
        c.sendMessage(resultX);
        c.sendMessage(resultY);
    }
