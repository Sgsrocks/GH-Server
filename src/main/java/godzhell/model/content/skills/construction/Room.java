...
//				System.err.println("Global Replacement Object missing parent: " + object.getX() + ", " + object.getY());
	...
	public void spawnObject(Player client, RoomObject object) {
		...
		if (object.getX() == 3 && object.getY() == 3) {
			...
			newCoords[0] = Map.getNewXCoord(rotation, (object.getRotation() == 0 || object.getRotation() == 2) ? objectDef.anInt761 : objectDef.anInt744, object.getX() & 7, object.getY() & 7,
					(object.getRotation() == 0 || object.getRotation() == 2) ? objectDef.anInt744 : objectDef.anInt761);
			newCoords[1] = Map.getNewYCoord(object.getY() & 7, (object.getRotation() == 0 || object.getRotation() == 2) ? objectDef.anInt761 : objectDef.anInt744, rotation, (object.getRotation() == 0 || object.getRotation() == 2) ? objectDef.anInt744
					: objectDef.anInt761, object.getX() & 7);
		}
