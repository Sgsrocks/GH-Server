package godzhell.model.content.skills.agility.impl;
...
public class BarbarianAgility {
	...
	public boolean barbarianCourse(final Player c, final int objectId) {
		...
		case BARBARIAN_WALL_OBJECT:
			...
			if (c.getAgilityHandler().hotSpot(c, 2535, 3553) || c.getAgilityHandler().hotSpot(c, 2536, 3552) || c.getAgilityHandler().hotSpot(c, 2536, 3554) && c.getAgilityHandler().agilityProgress[4] == true) {
			...
			} else if (c.getAgilityHandler().hotSpot(c, 2538, 3553) || c.getAgilityHandler().hotSpot(c, 2539, 3552) || c.getAgilityHandler().hotSpot(c, 2539, 3554) && c.getAgilityHandler().agilityProgress[5] == true) {
				//c.getAgilityHandler().move(c, 2, 0, c.getAgilityHandler().getAnimation(objectId), -1);
			...
			} else if (c.getAgilityHandler().hotSpot(c, 2541, 3553) || c.getAgilityHandler().hotSpot(c, 2542, 3552) || c.getAgilityHandler().hotSpot(c, 2542, 3554) && c.getAgilityHandler().agilityProgress[6] == true) {
				//c.getAgilityHandler().move(c, 2, 0, c.getAgilityHandler().getAnimation(objectId), -1);
				c.setForceMovement(2543, 3553, 0, 200, "EAST", c.getAgilityHandler().getAnimation(objectId));
				c.getAgilityHandler().lapFinished(c, 6, c.getMode().getType().equals(ModeType.OSRS) ? 616 : 10600, 8000);
