package godzhell.model.content.skills.agility;
...
import godzhell.model.content.skills.agility.impl.rooftop.RooftopArdougne;
import godzhell.model.content.skills.agility.impl.rooftop.RooftopSeers;
import godzhell.model.content.skills.agility.impl.rooftop.RooftopVarrock;
...
public class AgilityHandler {
	...
	public void lapProgress(Player c, int progress, int obj) {
		if (!(System.currentTimeMillis() - c.lastAgilAction < 1250)) {
			double exp = getXp(obj) * 5;
			c.getPlayerAssistant().addSkillXP((int) exp, 16, true);
			c.lastAgilAction = System.currentTimeMillis();
		}
	}
