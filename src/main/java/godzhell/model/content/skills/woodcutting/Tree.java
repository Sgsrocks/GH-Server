...
public enum Tree {
	...
	ARCHEY(new int[] { ObjectID.ACHEY_TREE }, ObjectID.ACHEY_TREE_STUMP, 2862, 1, 5, 100, 25, 15,  12000),
	...
	MATURE_JUNIPER(new int[] { ObjectID.MATURE_JUNIPER_TREE }, 27500, 13355, 42, 13, 65,35, 45, 6500),
	...
	HOLLOW(new int[] { ObjectID.HOLLOW_TREE_10821 }, 2310, 3239, 45, 13, 75, 100, 45, 6000),
	HOLLOW2(new int[] { ObjectID.HOLLOW_TREE_10830}, 4061, 3239, 45, 13, 75, 100, 45, 6000),
