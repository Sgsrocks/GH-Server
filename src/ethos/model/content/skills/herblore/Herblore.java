package ethos.model.content.skills.herblore;
...
import ethos.model.content.skills.herblore.PotionData.FinishedPotions;
import ethos.model.content.skills.herblore.PotionData.UnfinishedPotions;
...
public class Herblore {
	...
	public void clean(int itemId) {
		...
		herb.ifPresent(h -> {
			...
			player.getPA().addSkillXP(h.getExperience() * (player.getMode().getType().equals(ModeType.OSRS) ? 4 : Config.HERBLORE_EXPERIENCE), Skill.HERBLORE.getId(), true);
		...
		potion.ifPresent(p -> {
			...
			CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
				...
				public void execute(CycleEventContainer container) {
					...
					player.getPA().addSkillXP(p.getExperience() * (player.getMode().getType().equals(ModeType.OSRS) ? 4 : Config.HERBLORE_EXPERIENCE), Skill.HERBLORE.getId(), true);
