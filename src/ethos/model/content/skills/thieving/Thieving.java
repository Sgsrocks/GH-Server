package ethos.model.content.skills.thieving;
 ...
 */
	...
	public enum Stall {
		Baker(new GameItem(1893), 1, 16, 20, 45000),
		Spice(new GameItem(712), 65, 67, 10, 43000), 
		Silver(new GameItem(2961), 50, 54, 10, 40000), 
		Gem(new GameItem(1613), 75, 80, 10, 38000), 
		Scimitar(new GameItem(1993), 90, 100, 10, 36500),
		Fur(new GameItem(6814), 35, 47, 10, 40000),
		Silk(new GameItem(950), 25, 35, 10, 40000);
		/**
