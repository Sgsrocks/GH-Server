...
public class SpinMaterial {
	...
	private final class SpinEvent extends Event<Player> {
		...
		public void execute() {
			...
			attachment.getPA().addSkillXP(material.experience * (attachment.getMode().getType().equals(ModeType.OSRS) ? 4 : Config.CRAFTING_EXPERIENCE), Player.playerCrafting, true);
