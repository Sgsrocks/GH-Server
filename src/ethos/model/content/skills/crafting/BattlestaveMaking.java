...
import ethos.model.content.skills.crafting.CraftingData.battlestaveData;
import ethos.model.content.skills.crafting.CraftingData.battlestaveDialogueData;
					...
					CycleEventHandler.getSingleton().addEvent(3, c, new CycleEvent() {
						...
						public void execute(CycleEventContainer container) {
							...
							if (c.playerIsCrafting == true) {
								...
								c.getPA().addSkillXP((int) l.getXP() * (c.getMode().getType().equals(ModeType.OSRS) ? 4 : Config.CRAFTING_EXPERIENCE), 12, true);
								//c.startAnimation(1249);
								amount--;
								if (!c.getItems().playerHasItem(c.leatherType, l.getHideAmount())) {
									c.sendMessage("You have run out of resources.");
