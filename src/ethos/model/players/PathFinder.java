...
public class PathFinder {
	...
	public static void findRoute(Player c, int destX, int destY,
		...
		if (destX == c.getLocalX()
				&& destY == c.getLocalY() && !moveNear) {
			c.sendMessage("ERROR WITH PATHFINDING");
			return;
		} 

		destX = destX - (c.getMapRegionX() << 3);
		destY = destY - (c.getMapRegionY() << 3);
		...
		final int regionX = c.getMapRegionX() << 3;
		final int regionY = c.getMapRegionY() << 3;
		...
		while (tail != tileQueueX.size() && tileQueueX.size() < pathLength) {
			...
			if (curY > 0
					&& via[curX][curY - 1] == 0
					&& (getClip(curAbsX, curAbsY - 1, c.getHeight()) & 0x1280102) == 0) {
				tileQueueX.add(curX);
				tileQueueY.add(curY - 1);
				via[curX][curY - 1] = 1;
				cost[curX][curY - 1] = thisCost;
			...
			if (curX > 0
					&& via[curX - 1][curY] == 0
					&& (getClip(curAbsX - 1, curAbsY, c.getHeight()) & 0x1280108) == 0) {
				tileQueueX.add(curX - 1);
				tileQueueY.add(curY);
				via[curX - 1][curY] = 2;
				cost[curX - 1][curY] = thisCost;
			...
			if (curY < 104 - 1
					&& via[curX][curY + 1] == 0
					&& (getClip(curAbsX, curAbsY + 1, c.getHeight()) & 0x1280120) == 0) {
				tileQueueX.add(curX);
				tileQueueY.add(curY + 1);
				via[curX][curY + 1] = 4;
				cost[curX][curY + 1] = thisCost;
			...
			if (curX < 104 - 1
					&& via[curX + 1][curY] == 0
					&& (getClip(curAbsX + 1, curAbsY, c.getHeight()) & 0x1280180) == 0) {
				tileQueueX.add(curX + 1);
				tileQueueY.add(curY);
				via[curX + 1][curY] = 8;
				cost[curX + 1][curY] = thisCost;
			...
			if (curX > 0
					&& curY > 0
					&& via[curX - 1][curY - 1] == 0
					&& (getClip(curAbsX - 1, curAbsY - 1, c.getHeight()) & 0x128010e) == 0
					&& (getClip(curAbsX - 1, curAbsY, c.getHeight()) & 0x1280108) == 0
					&& (getClip(curAbsX, curAbsY - 1, c.getHeight()) & 0x1280102) == 0) {
				tileQueueX.add(curX - 1);
				tileQueueY.add(curY - 1);
			...
			if (curX > 0
					&& curY < 104 - 1
					&& via[curX - 1][curY + 1] == 0
					&& (getClip(curAbsX - 1, curAbsY + 1, c.getHeight()) & 0x1280138) == 0
					&& (getClip(curAbsX - 1, curAbsY, c.getHeight()) & 0x1280108) == 0
					&& (getClip(curAbsX, curAbsY + 1, c.getHeight()) & 0x1280120) == 0) {
				tileQueueX.add(curX - 1);
				tileQueueY.add(curY + 1);
			...
			if (curX < 104 - 1
					&& curY > 0
					&& via[curX + 1][curY - 1] == 0
					&& (getClip(curAbsX + 1, curAbsY - 1, c.getHeight()) & 0x1280183) == 0
					&& (getClip(curAbsX + 1, curAbsY, c.getHeight()) & 0x1280180) == 0
					&& (getClip(curAbsX, curAbsY - 1, c.getHeight()) & 0x1280102) == 0) {
				tileQueueX.add(curX + 1);
				tileQueueY.add(curY - 1);
			...
			if (curX < 104 - 1
					&& curY < 104 - 1
					&& via[curX + 1][curY + 1] == 0
					&& (getClip(curAbsX + 1, curAbsY + 1, c.getHeight()) & 0x12801e0) == 0
					&& (getClip(curAbsX + 1, curAbsY, c.getHeight()) & 0x1280180) == 0
					&& (getClip(curAbsX, curAbsY + 1, c.getHeight()) & 0x1280120) == 0) {
				tileQueueX.add(curX + 1);
				tileQueueY.add(curY + 1);
