...
import ethos.model.content.skills.construction.RoomInterface;
import ethos.model.content.skills.cooking.Cooking;
import ethos.model.content.skills.crafting.BattlestaveMaking;
import ethos.model.content.skills.crafting.BraceletMaking;
import ethos.model.content.skills.crafting.GlassBlowing;
import ethos.model.content.skills.crafting.LeatherMaking;
import ethos.model.content.skills.crafting.Tanning;
import ethos.model.content.skills.crafting.CraftingData.tanningData;
...
public class ClickingButtons implements PacketType {
	...
	public void processPacket(final Player c, int packetType, int packetSize) {
		...
		ethos.model.content.skills.magic.EnchantBoits.EnchantButton(c, actionButtonId);
		...
		case 135166:
			if(!Boundary.isIn(c, Boundary.KARAMJA_SHIPS)) {
				...
				ethos.model.content.traveling.CharterShips.startTravel(c, 1);
				} else {
		...
		case 135175:
			if(!Boundary.isIn(c, Boundary.PORT_SARIM_SHIPS)) {
				if(Boundary.isIn(c, Boundary.KARAMJA_SHIPS)) {
				ethos.model.content.traveling.CharterShips.startTravel(c, 2);
				} else {
