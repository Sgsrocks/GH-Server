...
public class PlayerAssistant {
	...
	public void sendUpdateItems(int frame, GameItem[] items) {
	...
	public void homeTele(final Player c) {
		if(c.HomeTeleport) {
			return;
		}
		c.HomeTeleport = true;
	...
	public void levelUp(int skill) {
		...
		case 20:
			...
			case 21:
				sendFrame126("Congratulations, you just advanced a Hunter level!", 34628);
				sendFrame126("Your Hunter level is now " + getLevelForXP(c.playerXP[skill]) + ".", 34629);
				c.sendMessage("Congratulations, you just advanced a Hunter level.");
				sendFrame164(34627);
				break;
		case 22:
			sendFrame126("Congratulations, you just advanced a Construction level!", 34634);
			sendFrame126("Your Construction level is now " + getLevelForXP(c.playerXP[skill]) + ".", 34635);
	...
	public boolean addSkillXP(double amount, int skill) {
		return addSkillXP((int) amount, skill, false);
	}
	...
	public void placeObject(int objectId, int objectX, int objectY, int heightLevel2, int objectFace, int objectType) {
