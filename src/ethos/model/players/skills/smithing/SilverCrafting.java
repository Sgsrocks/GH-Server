package ethos.model.players.skills.smithing;
...
public class SilverCrafting {
    ...
    public static void makeSilver(final Player player, int buttonId,
        ...
        if (silverCraft.getUsed() == SILVER_BAR && player.isCrafting) {
            ...
            if (!player.getItems().playerHasItem(SILVER_BAR)) {
            ...
            CycleEventHandler.getSingleton().addEvent(player, new CycleEvent() {
                ...
                public void execute(CycleEventContainer container) {
                    ...
                    player.getItems().deleteItem(SILVER_BAR, 1);
                    player.getItems().addItem(silverCraft.getResult(),
                            1);
