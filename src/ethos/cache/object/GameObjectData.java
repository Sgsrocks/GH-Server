...
public class GameObjectData {
	 ...
	 */
	public static final int MAX_DEFINITIONS = 37960;
		...
		if (id < definitions.length) {
			if (definitions[id] == null) {
                ...
                if (def == null)
                    ...
                    GameObjectData obj = new GameObjectData(id, def.name, description, def.xLength(), def.yLength(), def.solid(), def.isWalkable, def.hasActions, def.aBoolean779, def.walkType);
                    definitions[id] = obj;
                } 
            }
