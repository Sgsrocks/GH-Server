 ...
 */
	 ...
	 */
	public static final int WOODCUTTING_EXPERIENCE = 2;		//14
	public static final int MINING_EXPERIENCE = 2;			//15
	public static final int SMITHING_EXPERIENCE = 2;		//24
	public static final int FARMING_EXPERIENCE = 2;			//10
	public static final int FIREMAKING_EXPERIENCE = 2;		//13
	public static final int HERBLORE_EXPERIENCE = 2;		//13
	public static final int FISHING_EXPERIENCE = 2;			//43
	public static final int AGILITY_EXPERIENCE = 2;			//40
	public static final int PRAYER_EXPERIENCE = 2;			//35
	public static final int RUNECRAFTING_EXPERIENCE = 2;	//20
	public static final int CRAFTING_EXPERIENCE = 2;		//8
	public static final int THIEVING_EXPERIENCE = 2;		//20
	public static final int SLAYER_EXPERIENCE = 2;			//15
	public static final int COOKING_EXPERIENCE = 2;			//34
	public static final int FLETCHING_EXPERIENCE = 2;		//20
	public static final int HUNTER_EXPERIENCE = 2;			//15
	public static final int CONSTRUCTION_EXPERIENCE = 2;
	//shop ids
